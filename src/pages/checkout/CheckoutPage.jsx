...
import { CheckoutContainer,CheckoutBackground, CheckoutResponsive} from '../../components/ui/checkout';
          ...
          <div className="lg:col-span-2">
            ...
            <form className="mt-8">
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                <button type="button"
                  className="px-7 py-3.5 text-sm tracking-wide bg-white hover:bg-gray-50 text-gray-800 rounded-md" onClick={prevToCart}>Back</button>
                  <button className="px-7 py-3.5 text-sm tracking-wide bg-blue-600 text-white rounded-md hover:bg-blue-700" onClick={handleCheckout}>Submit</button>
              </div>
            </form>
          </div>
